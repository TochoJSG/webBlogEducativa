const bd = require('./BaseDeDatos.png');
const backend = require('./Backend.png');
const Frontend = require('./Frontend.png');
const Programacion = require('./Programacion.png');
...
const InvestigacionDeOperaciones = require('./Investigacion-de-operaciones.png');
const Informatica = require('./Informatica.png');
const BigData = require('./BigData.png');
const Requerimientos = require('./Requerimientos.png');
